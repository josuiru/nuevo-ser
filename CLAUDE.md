...
- **Arco 2 (doc 08) — inicio**: 2.1 Bajar solo (post-1.14), 2.2 Rexán (primer maestro nuevo, color ámbar, elección sobre 1/2 vs 2/4 con respuesta condicional), 2.3 El primer Fragmento Espejo (tutorial narrativo de familia D / equivalencia, cierre amable). Nuevas voces: Rexán (ámbar), Ari (verde), Zafrán ya existía. Pendientes Arco 2: 2.4 variantes, 2.5 pintada, 2.6 Zafrán mencionado, 2.7 tutorial Duales (FR.16 + MCM), 2.8 Rexán+agua, 2.9 Ari, 2.10 silbido, 2.11 Sora baja, 2.12 noche Zafrán, 2.13 combate jugable, 2.14-2.16 cierre.
