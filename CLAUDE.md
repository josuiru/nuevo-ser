...
- **Arco 3 (doc 09) — apertura**: 3.1 Naini (Mercado de la Luz, proporciones como "valor en circulación"), 3.2 Mercado (tutorial PROP.04 con manzanas 15+10, 1/3+1/2=10 y 10/25=40%), 3.3 Kai otra vez (propone duelo). **Duelo Kai jugable** (`DesafioKurz.duelKai`): Kai como vocero, halo rosa acento, sin ojos, 3 preguntas (reacción/precisión/Duales). 3.5 Kai desaparece (Ari consuela: "has estado bien"). Voz nueva: Vadic (gris metal `PaletaNeon.grisMetal`). Pendientes Arco 3: 3.4 cinemática del duelo (ahora solo lanza combate), 3.6-3.18.
