...
- **Estación 2.1 + latentes 2.A + Estación 2.2 implementadas (F2-1, F2-2, F2-3)**: `apps/las-versiones/lib/dominio/escenas_arco_2.dart` cubre la apertura 2.0.1, las 6 cinemáticas de la Estación 2.1 (Pompaelo bajo Iruña, doc 08 §2.1.1–2.1.6), las 2 cinemáticas latentes post-Estación 2.1 (2.A.1 *El libro de Quintiliano* + 2.A.2 *Marina y los descansos*) y las 6 cinemáticas de la Estación 2.2 (Quintiliano de Calagurris, doc 08 §2.2.1–2.2.6). Total: 15 cinemáticas en el catálogo del Arco 2. El orquestador encadena Arco 1 → Arco 2 cruzando `arco_1_cerrado_por_la_cronista`; la Estación 2.2 arranca con 2.2.1 que requiere `escena_2_a_2_vista` y cierra con 2.2.6 que activa `arco_2_estacion_2_cerrada`. La Estación 2.2 introduce HF.10 (detección de omisiones) narrativamente y articula la postura epistémica del oficio frente a fuentes textuales con autoría individual y silencios significativos ("las cosas son y dejan de ser"). Voz nueva `VozPersonaje.arqueologa` (femenina, etiqueta funcional "Arqueóloga", simétrica al `arqueologo` masculino de Irulegi) + 2 ambientes nuevos (`yacimientoCalahorra`, `salaTrabajoMuseoCalahorra`). Las fases jugables de las Brechas 2.1 y 2.2 quedan pendientes hasta el refactor de `FaseBrecha`. La Estación 2.2 preserva información histórica trazable (fecha 1076 — Calagurris navarra hasta la conjura de Peñalén, pasajes I/II/IV/VI de la *Institutio Oratoria*, Vitorio Marcelo como dedicatario del libro IV) sin sustituciones globales. Las 19+ cinemáticas restantes + Brechas 2.3/2.4 + Mosaico M2 quedan pendientes.
