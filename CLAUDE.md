...
- **Arco 2 — Estaciones 2.1 + 2.2 + 2.3 + latentes 2.A/2.B implementadas (F2-1 a F2-5)**: `apps/las-versiones/lib/dominio/escenas_arco_2.dart` cubre la apertura 2.0.1, las 6 cinemáticas de la Estación 2.1 (Pompaelo bajo Iruña), las 2 latentes post-Estación 2.1 (2.A.1 + 2.A.2), las 6 cinemáticas de la Estación 2.2 (Quintiliano de Calagurris), la latente 2.B.1 (cuaderno de Isaura) y las 6 cinemáticas de la Estación 2.3 (La domus de los mosaicos, doc 08 §2.3.1–2.3.6). Total: 22 cinemáticas. La 2.3 es pedagógicamente la más densa del arco — crisis emocional de Maren ante la asimetría documental (un Cornelio con inscripción y dos personas esclavizadas sin nombre), lección de Isaura sobre la dicotomía neutralidad/comprensión (PH.01 no presentismo + PH.08 comprender sin justificar), reconstrucción con la afirmación 6 declarada como **Sólido (la ausencia)** ("la ausencia documentada es información"), y Concilio formal donde Karim alcanza a Maren en el pasillo con "la afirmación 6 es de las que me hacen tener esperanza con esta institución". Voz nueva `arqueologa` (femenina, simétrica al `arqueologo` de Irulegi) + 4 ambientes nuevos (`yacimientoCalahorra`, `salaTrabajoMuseoCalahorra`, `despachoIsaura`, `domusMosaicosSubterranea`). Las fases jugables de las Brechas 2.1/2.2/2.3 quedan pendientes hasta el refactor de `FaseBrecha`. Sustituciones diegéticas residuales: la inscripción romana de 2.1.2 es modelo literario verosímil, la domus de los mosaicos y la familia Cornelia son explícitamente ficticias diegéticas (registro completo en `BLOQUEOS-PENDIENTES.md`). Las 12+ cinemáticas restantes + Brecha 2.4 + Mosaico M2 + cierre 2.Z quedan pendientes.
