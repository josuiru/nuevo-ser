...
- **Estación 2.1 + latentes 2.A + Estación 2.2 + latente 2.B.1 implementadas (F2-1, F2-2, F2-3, F2-4)**: `apps/las-versiones/lib/dominio/escenas_arco_2.dart` cubre la apertura 2.0.1, las 6 cinemáticas de la Estación 2.1 (Pompaelo bajo Iruña, doc 08 §2.1.1–2.1.6), las 2 cinemáticas latentes post-Estación 2.1 (2.A.1 *El libro de Quintiliano* + 2.A.2 *Marina y los descansos*), las 6 cinemáticas de la Estación 2.2 (Quintiliano de Calagurris, doc 08 §2.2.1–2.2.6) y la cinemática latente post-Estación 2.2 (2.B.1 *El cuaderno de Isaura* — Maren descubre que la mentora lleva su propio cuaderno desde hace treinta años, "preguntas, sólo"). Total: 16 cinemáticas en el catálogo del Arco 2. La Estación 2.2 introduce HF.10 (detección de omisiones) narrativamente y articula la postura epistémica del oficio frente a fuentes textuales con autoría individual y silencios significativos ("las cosas son y dejan de ser"). 2.B.1 confirma al jugador que el oficio del Cuaderno es práctica vitalicia, no etapa de aprendiz. Voz nueva `VozPersonaje.arqueologa` (femenina, simétrica al `arqueologo` masculino de Irulegi) + 3 ambientes nuevos (`yacimientoCalahorra`, `salaTrabajoMuseoCalahorra`, `despachoIsaura`). Las fases jugables de las Brechas 2.1 y 2.2 quedan pendientes hasta el refactor de `FaseBrecha`. La Estación 2.2 preserva información histórica trazable (fecha 1076 — Calagurris navarra hasta la conjura de Peñalén, pasajes I/II/IV/VI de la *Institutio Oratoria*, Vitorio Marcelo como dedicatario del libro IV) sin sustituciones globales. Las 18+ cinemáticas restantes + Brechas 2.3/2.4 + Mosaico M2 quedan pendientes.
