...
function gxare_seed_descargas(): array {
	return array(
		...
		array(
			'seed_id'  => 'desc-naturaleza-1.0.4',
			'post_type'=> 'gxare_descarga',
			'slug'     => 'naturaleza-apk-1-0-4',
			'orden'    => 20,
			'title'    => 'Naturaleza — APK Android',
			'meta' => array(
				'gxare_descarga_proyecto_slug' => 'cuadernos-de-campo-naturaleza',
				'gxare_descarga_version'       => '1.0.4+5',
				'gxare_descarga_fecha'         => '2026-05-20',
				'gxare_descarga_plataforma'    => 'android',
				'gxare_descarga_url'           => 'https://github.com/JosuIru/cuadernos-de-campo/releases/download/naturaleza-v1.0.4/naturaleza-1.0.4+5.apk',
				'gxare_descarga_peso'          => '~77 MB',
				'gxare_descarga_notas'         => 'Avisos de actualización integrados (a partir de esta versión la app sola te dirá cuando haya una nueva). Salidas de campo como unidad narrativa, tipos de evidencia, hipótesis personal con validación posterior, anotaciones al margen.',
			),
		),
		array(
