...
function gxare_seed_descargas(): array {
	return array(
		...
		array(
			'seed_id'  => 'desc-naturaleza-1.0.5',
			'post_type'=> 'gxare_descarga',
			'slug'     => 'naturaleza-apk-1-0-5',
			'orden'    => 20,
			'title'    => 'Naturaleza — APK Android',
			'meta' => array(
				'gxare_descarga_proyecto_slug' => 'cuadernos-de-campo-naturaleza',
				'gxare_descarga_version'       => '1.0.5+6',
				'gxare_descarga_fecha'         => '2026-05-20',
				'gxare_descarga_plataforma'    => 'android',
				'gxare_descarga_url'           => 'https://github.com/JosuIru/cuadernos-de-campo/releases/download/naturaleza-v1.0.5/naturaleza-1.0.5+6.apk',
				'gxare_descarga_peso'          => '~77 MB',
				'gxare_descarga_notas'         => 'Mi fenología (primer registro de cada especie por año) y Tasa de acierto (calibración tras validar identificaciones). Avisos de actualización integrados. Salidas como unidad narrativa, tipos de evidencia, hipótesis personal, anotaciones al margen.',
			),
		),
		array(
