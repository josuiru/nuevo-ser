...
function gxare_seed_descargas(): array {
	return array(
		...
		array(
			'seed_id'  => 'desc-naturaleza-1.0.3',
			'post_type'=> 'gxare_descarga',
			'slug'     => 'naturaleza-apk-1-0-3',
			'orden'    => 20,
			'title'    => 'Naturaleza — APK Android',
			'meta' => array(
				'gxare_descarga_proyecto_slug' => 'cuadernos-de-campo-naturaleza',
				'gxare_descarga_version'       => '1.0.3+4',
				'gxare_descarga_fecha'         => '2026-05-20',
				'gxare_descarga_plataforma'    => 'android',
				'gxare_descarga_url'           => 'https://github.com/JosuIru/cuadernos-de-campo/releases/download/naturaleza-v1.0.3/naturaleza-1.0.3+4.apk',
				'gxare_descarga_peso'          => '~77 MB',
				'gxare_descarga_notas'         => 'Salidas de campo como unidad narrativa: track + meteo + N hallazgos en un solo contenedor. Tipos de evidencia (huellas, plumas, sonidos…) como ciudadanos de primera clase. Hipótesis personal + validación posterior. Anotaciones al margen.',
			),
		),
		array(
