...
| F1-A2 Modelos + BD | pendiente | ~14 modelos POJO (Olivar, Parcela, Olivo, Campania, Recoleccion, PartidaAceituna, Molturacion, LoteAceite, Movimiento, Venta, Tratamiento, Incidencia, Analitica, Titular) + sqflite v1 con tablas, FK, índices, migraciones aditivas. Tests POJO |
| F1-A3 Pantallas básicas | pendiente | PantallaHoy (dashboard campaña activa), PantallaMapa (polígonos SIGPAC), PantallaListaParcelas, PantallaFichaParcela, PantallaCampania, PantallaMolturacion, PantallaLibroAceite, PantallaCuadernoPac, PantallaOnboarding, PantallaAjustes — sin catálogos curados (text input libre hasta F1-A6) |
