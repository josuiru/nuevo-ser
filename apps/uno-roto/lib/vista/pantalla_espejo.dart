...
/// no corte.
///
/// Devuelve `true` cuando el jugador acierta, `false` si se rinde o
/// abandona. Los fallos no terminan el puzzle — sigue hasta que elija
/// bien o huya.
class PantallaEspejo extends StatefulWidget {
  final int numerador;
  final int denominador;

  const PantallaEspejo({
    super.key,
...
class _PantallaEspejoState extends State<PantallaEspejo>
  ...
  late ProblemaEspejo _problema;
  int? _indiceSeleccionado;
  bool _revelado = false;
  bool _mostrandoDemo = false;
  static const _idDemo = 'espejo';
  ...
  void initState() {
    ...
    _problema = GeneradorEspejo().generar(
      numeradorBase: widget.numerador,
      denominadorBase: widget.denominador,
    );
