...
class _PantallaAmplificarState extends State<PantallaAmplificar>
  ...
  void _elegir(int indice) {
    ...
    if (indice == _problema.indiceCorrecto) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.amplificar);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.amplificar),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
