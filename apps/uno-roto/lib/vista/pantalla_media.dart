...
/// Puzzle EST.03: el niño ve "media de [4, 6, 8, 10]" y elige el
/// resultado entre cuatro candidatos. Mecánica suma/cantidad.
class PantallaMedia extends StatefulWidget {
  final ProblemaMedia? problemaPredeterminado;

  const PantallaMedia({super.key, this.problemaPredeterminado});

  @override
  State<PantallaMedia> createState() => _PantallaMediaState();
}

class _PantallaMediaState extends State<PantallaMedia>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controladorCielo;
  late final EstadoPistaPuzzle _pista;
  late ProblemaMedia _problema;
  int? _indiceSeleccionado;
  bool _revelado = false;
  bool _mostrandoDemo = false;
  static const _idDemo = 'media';
  ...
  void initState() {
    ...
    _problema = widget.problemaPredeterminado ??
        GeneradorMedia().generar(dificultad: 1);
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.media);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          Text(AppLocalizations.of(contexto).puzzleHeaderMedia,
                            style: const TextStyle(
                      ...
                      Text(
                        AppLocalizations.of(contexto).puzzleInstrCalculaMedia,
                      ...
                      const SizedBox(height: 22),
                      _TarjetaDatos(datos: _problema.datos),
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.media),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
