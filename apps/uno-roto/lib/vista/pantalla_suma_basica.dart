...
class _PantallaSumaBasicaState extends State<PantallaSumaBasica>
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.sumaBasica);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.sumaBasica),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
