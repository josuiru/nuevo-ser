...
/// Pariente de [PantallaEspejo] pero con un ganador único — el mínimo.
class PantallaSimplificar extends StatefulWidget {
  final int numerador;
  final int denominador;

  const PantallaSimplificar({
    super.key,
  ...
  @override
  State<PantallaSimplificar> createState() => _PantallaSimplificarState();
}

class _PantallaSimplificarState extends State<PantallaSimplificar>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controladorCielo;
  late final EstadoPistaPuzzle _pista;
  late ProblemaSimplificar _problema;
  int? _indiceSeleccionado;
  bool _revelado = false;
  bool _mostrandoDemo = false;
  static const _idDemo = 'simplificar';
  ...
  void _elegir(int indice) {
    ...
    if (indice == _problema.indiceCorrecto) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.simplificar);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      _TarjetaObjetivo(etiqueta: _problema.objetivo.etiqueta),
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.simplificar),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
...
class _TarjetaObjetivo extends StatelessWidget {
  ...
  const _TarjetaObjetivo({required this.etiqueta});
