...
class _PantallaLecturaFraccionState extends State<PantallaLecturaFraccion>
  ...
  static const _idDemo = 'lectura_fraccion';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.lecturaFraccion);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.lecturaFraccion),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
