...
class _PantallaOrdenarFraccionesState extends State<PantallaOrdenarFracciones>
  ...
  static const _idDemo = 'ordenar_fracciones';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.ordenarFracciones);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.ordenarFracciones),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
