...
class _PantallaProporcionalState extends State<PantallaProporcional>
  ...
  void _elegir(int indice) {
    ...
    if (indice == _problema.indiceCorrecto) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.proporcional);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.proporcional),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
