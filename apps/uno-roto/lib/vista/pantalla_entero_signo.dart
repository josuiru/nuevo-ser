...
class _PantallaEnteroSignoState extends State<PantallaEnteroSigno>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controladorCielo;
  late final EstadoPistaPuzzle _pista;
  late ProblemaEnteroSigno _problema;
  int? _indiceSeleccionado;
  bool _revelado = false;
  bool _mostrandoDemo = false;
  static const _idDemo = 'entero_signo';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    CabeceraPuzzle(alHuir: _huir, titulo: 'ENTEROS'),
