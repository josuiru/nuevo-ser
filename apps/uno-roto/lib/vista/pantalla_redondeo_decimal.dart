...
/// los errores reales: truncar, redondear-pero-rellenar, redondear de
/// más, truncar-y-rellenar.
class PantallaRedondeoDecimal extends StatefulWidget {
  final ProblemaRedondeoDecimal? problemaPredeterminado;

  const PantallaRedondeoDecimal({super.key, this.problemaPredeterminado});

  @override
  State<PantallaRedondeoDecimal> createState() =>
      _PantallaRedondeoDecimalState();
}

class _PantallaRedondeoDecimalState extends State<PantallaRedondeoDecimal>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controladorCielo;
  late final EstadoPistaPuzzle _pista;
  late ProblemaRedondeoDecimal _problema;
  int? _indiceSeleccionado;
  bool _revelado = false;
  bool _mostrandoDemo = false;
  static const _idDemo = 'redondeo_decimal';
  ...
  void initState() {
    ...
    _problema = widget.problemaPredeterminado ??
        GeneradorRedondeoDecimal().generar(dificultad: 2);
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.redondeoDecimal);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      _TarjetaTexto(texto: _problema.etiquetaOriginal),
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.redondeoDecimal),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
