...
class _PantallaGraficoCircularState extends State<PantallaGraficoCircular>
  ...
  static const _idDemo = 'grafico_circular';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.graficoCircular);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.graficoCircular),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
