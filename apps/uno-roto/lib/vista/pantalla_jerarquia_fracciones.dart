...
class _PantallaJerarquiaFraccionesState
  ...
  static const _idDemo = 'jerarquia_fracciones';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.jerarquiaFracciones);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.jerarquiaFracciones),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
