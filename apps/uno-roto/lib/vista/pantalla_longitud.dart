...
class _PantallaLongitudState extends State<PantallaLongitud>
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.longitud);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          Text(AppLocalizations.of(contexto).puzzleHeaderLongitud,
                            style: const TextStyle(
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.longitud),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
