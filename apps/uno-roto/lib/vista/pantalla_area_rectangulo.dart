...
class _PantallaAreaRectanguloState extends State<PantallaAreaRectangulo>
  ...
  static const _idDemo = 'area_rectangulo';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.areaRectangulo);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.areaRectangulo),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
