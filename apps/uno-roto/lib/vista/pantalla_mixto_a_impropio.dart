...
class _PantallaMixtoAImpropioState extends State<PantallaMixtoAImpropio>
  ...
  static const _idDemo = 'mixto_a_impropio';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.mixtoAImpropio);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.mixtoAImpropio),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
