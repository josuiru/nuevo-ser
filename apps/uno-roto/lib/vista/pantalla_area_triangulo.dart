...
class _PantallaAreaTrianguloState extends State<PantallaAreaTriangulo>
  ...
  static const _idDemo = 'area_triangulo';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.areaTriangulo);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.areaTriangulo),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
