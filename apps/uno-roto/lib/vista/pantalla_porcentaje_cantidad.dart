...
class _PantallaPorcentajeCantidadState
  ...
  static const _idDemo = 'porcentaje_cantidad';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.porcentajeCantidad);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.porcentajeCantidad),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
