...
class _PantallaAumentoDescuentoState extends State<PantallaAumentoDescuento>
  ...
  static const _idDemo = 'aumento_descuento';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.aumentoDescuento);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.aumentoDescuento),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
