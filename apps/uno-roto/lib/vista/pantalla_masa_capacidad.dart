...
/// (escalera ×10) pero rota entre familias masa y capacidad.
class PantallaMasaCapacidad extends StatefulWidget {
  final ProblemaMasaCapacidad? problemaPredeterminado;

  const PantallaMasaCapacidad({super.key, this.problemaPredeterminado});

  @override
  State<PantallaMasaCapacidad> createState() => _PantallaMasaCapacidadState();
}

class _PantallaMasaCapacidadState extends State<PantallaMasaCapacidad>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controladorCielo;
  late final EstadoPistaPuzzle _pista;
  late ProblemaMasaCapacidad _problema;
  int? _indiceSeleccionado;
  bool _revelado = false;
  bool _mostrandoDemo = false;
  static const _idDemo = 'masa_capacidad';
  ...
  void initState() {
    ...
    _problema = widget.problemaPredeterminado ??
        GeneradorMasaCapacidad().generar(dificultad: 1);
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.masaCapacidad);
      if (!mounted) return;
  ...
  String get _tituloFamilia =>
      _problema.familia == FamiliaMetrica.masa ? 'MASA' : 'CAPACIDAD';
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      _TarjetaConversion(
                        ...
                        simboloOrigen: _problema.simboloOrigen,
                        simboloDestino: _problema.simboloDestino,
                      ),
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.masaCapacidad),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
