...
class _PantallaDivisoresState extends State<PantallaDivisores>
  ...
  static const _idDemo = 'divisores';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.divisores);
      if (!mounted) return;
        ...
        builder: (_, __) {
          return Stack(
            ...
            children: [
              ...
              BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.divisores),
              if (_mostrandoDemo)
                OverlayDemoPuzzle(
