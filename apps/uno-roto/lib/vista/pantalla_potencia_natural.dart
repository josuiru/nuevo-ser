...
/// Puzzle ARI.02: el niño ve `2⁴` y elige el resultado entre cuatro
...
class PantallaPotenciaNatural extends StatefulWidget {
  ...
  State<PantallaPotenciaNatural> createState() =>
      _PantallaPotenciaNaturalState();
}

class _PantallaPotenciaNaturalState extends State<PantallaPotenciaNatural>
    with SingleTickerProviderStateMixin {
  late final AnimationController _controladorCielo;
  late final EstadoPistaPuzzle _pista;
  late ProblemaPotenciaNatural _problema;
  int? _indiceSeleccionado;
  bool _revelado = false;
  bool _mostrandoDemo = false;
  static const _idDemo = 'potencia_natural';
  ...
  void _elegir(int indice) {
    ...
    if (_problema.esCorrecta(indice)) {
      ...
      comprobarYAyudarSiProcede(context, _pista, TipoFragmentoEnTejado.potenciaNatural);
      if (!mounted) return;
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    CabeceraPuzzle(alHuir: _huir, titulo: 'POTENCIA'),
                ...
                BotonAyudaPuzzle(destacar: _pista.activa, tipo: TipoFragmentoEnTejado.potenciaNatural),
          if (_mostrandoDemo)
              OverlayDemoPuzzle(
                mensaje:
