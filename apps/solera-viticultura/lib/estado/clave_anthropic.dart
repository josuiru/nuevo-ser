...
///
/// Modelo "BYO key" típico de apps que usan IA en v0.1 sin backend
/// propio. Cuando llegue la fase de backend nube, la opción será
/// centralizar y cobrar por uso, pero esto requiere infraestructura
/// adicional y monetización ya cerrada.
class ClaveAnthropic {
  static const _claveStorage = 'solera_viticultura.anthropic.clave';
