/// Tercero económico: cliente o proveedor de la bodega/viticultor.
/// La pareja natural en viticultura es la cooperativa o la
/// distribuidora — por eso una sola tabla con campo `tipo` que
...
/// NIF vacío (venta directa a particular en bodega) — esos apuntes
/// el resumen anual los lista aparte porque NO entran al 347.
class Tercero {
  final int? id;
  final String nif;
  final String nombre;
