/// Track de inspección: ruta GPS por la finca con duración y
/// distancia. El operador lo graba al recorrer una zona y luego lo
/// puede revisar (mapa) o exportar (GPX/PDF) como prueba de visita.
///
/// Patrón heredado de fósiles/naturaleza: persistencia incremental de
/// puntos en `track_grabacion_buffer` para que la grabación sobreviva
/// a un crash o kill OS, y consolidación al arrancar.
class Track {
  final int? id;
  final int fechaMs;
  final String nombre;
