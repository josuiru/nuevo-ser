...
/// Configuración de la clave Anthropic. La clave se guarda solo en
/// SharedPreferences local del dispositivo. Las llamadas a Claude vision
/// van directas desde el móvil del usuario — Solera Apícola no tiene
/// servidor intermedio en v0.1.
///
/// Tradeoff explícito: el usuario paga su propio uso de Anthropic
/// (~0,001-0,01 € por análisis con haiku). A cambio no hay suscripción
/// que cobrar todavía. Cuando entre la fase de backend nube, podemos
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Identifica varroa, nosema, loque y otras patologías por foto',
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Solera Apícola puede usar Claude AI de Anthropic para analizar la foto que adjuntas a una incidencia y proponer un diagnóstico, severidad y manejo cultural. Si detecta una patología de declaración obligatoria (loque americana, vespa velutina, escarabajo de las colmenas) lo destaca con banner rojo.',
                  ),
                ],
              ),
            ),
