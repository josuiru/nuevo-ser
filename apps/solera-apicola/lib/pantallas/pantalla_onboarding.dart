...
///
/// Tono: directo, profesional. No es un juego — el usuario es apicultor
/// profesional o semi-profesional y aprecia que se le respete el tiempo.
class PantallaOnboarding extends StatefulWidget {
  /// Callback que el orquestador (main) ejecuta cuando el usuario pulsa
  /// "Empezar". Marca el flag y reemplaza esta pantalla por el mapa.
  final VoidCallback alTerminar;

  const PantallaOnboarding({super.key, required this.alTerminar});

  static const claveOnboardingVisto = 'solera_apicola.onboarding.visto';
...
const _paginas = <_DatosPagina>[
  _DatosPagina(
    Icons.hive,
    'Tus colmenas en el mapa',
    'Cataloga cada colmena con matrícula, raza, año de la reina y ubicación GPS. '
        'Trashumancia bien modelada: la colmena es identidad persistente, los movimientos '
        'son eventos con origen, destino y fecha.',
  ),
  _DatosPagina(
    Icons.auto_awesome,
    'Diagnóstico con IA por foto',
    'Hazle una foto a un panal o una colmena con síntomas y la IA propone diagnóstico '
        '(varroa, nosema, loque, vespa velutina…). Patologías de declaración obligatoria '
        'se destacan automáticamente. Tú decides; nada se aplica sin tu revisión y receta '
        'del veterinario asesor.',
  ),
  _DatosPagina(
    Icons.description,
    'Libro REGA al alcance',
    'Registra cada tratamiento sanitario con su sustancia activa, lote, factura y plazo de '
        'seguridad. Exporta el libro oficial (REGA / SITRAN-AP) en PDF firmable para inspección.',
  ),
];
