...
/// van directas desde el móvil del operario — Solera Arbolado Urbano no
/// tiene servidor intermedio en v0.1.
      ...
      body: ListView(
        ...
        children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Identifica especies y plagas urbanas por foto',
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Solera Arbolado Urbano puede usar Claude AI de Anthropic para analizar la foto que adjuntas a una incidencia y proponer un diagnóstico fitosanitario, severidad y manejo cultural. Si detecta una plaga de declaración obligatoria (picudo rojo, fuego bacteriano) o riesgo sanitario público (procesionaria, lagarta peluda) lo destaca con banner.',
                  ),
                ],
              ),
            ),
          ...
          const Text(
            ...
            '· Cuidado con la privacidad ciudadana: las fotos pueden capturar transeúntes — encuadra al árbol.',
