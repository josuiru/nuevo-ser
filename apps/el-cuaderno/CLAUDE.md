...
Tests: 240 verde en el-cuaderno (Dart) + 51 en `nuevo_ser_companion` + smoke PHP verde + paridad P5 12/12 + paridad calibración Brier verde. APK debug compila.
