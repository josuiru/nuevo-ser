/// Factura emitida — conforme al Reglamento de Facturación
/// (RD 1619/2012) español.
///
/// `numeroFactura` se autogenera con formato serie secuencial
/// (ej. 2026-0001, 2026-0002...). El receptor puede ser un
/// `Tercero` (con NIF para modelo 347) o un particular (venta
/// directa, NIF opcional).
///
/// `lineasJson` almacena el detalle de líneas de factura:
/// [{"descripcion", "cantidad", "precioUnitario", "importe"}]
///
...
class Factura {
  ...
  final double total;
  final String estado; // emitida / pagada / vencida / anulada
  final String notas;
